import { AdmConfigService } from './../../core/services/adm-config.service';
...
@Component({
  ...
  templateUrl: './config-adm.component.html',
  styleUrl: './config-adm.component.css',
})
export class ConfigAdmComponent implements OnInit {
  constructor(
